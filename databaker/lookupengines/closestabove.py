class ClosestAboveEngine(object):
    ...
    def __init__(self, cell_bag):
        ...
        for cell in cell_bag:
            ...
            if cell.value in break_points.keys():
                raise Exception("Aborting. You have defined two or more equally valid CLOSEST, ABOVE relationships")
        ...
        # TODO - not subtle
        # Now add the very last/highest range. We'll set the maximum y to 99999999999
        ranges.update({x:
